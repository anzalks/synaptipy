...
def generate_voltage_clamp_step(duration=1.0, step_start=0.2, step_duration=0.5, 
                               baseline=-70.0, step_amplitude=-10.0, sampling_rate=10000):
    """
...
def generate_current_response(voltage_time, voltage_data, input_resistance=100.0, 
                             capacitance=20.0, sampling_rate=10000, noise_level=0.02):
    """
