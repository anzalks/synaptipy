...
class NwbMetadataDialog(QtWidgets.QDialog):
    ...
    def _create_subject_tab(self) -> QtWidgets.QWidget:
        ...
        self.species.addItems(["", "Mus musculus", "Rattus norvegicus", "Homo sapiens", "Drosophila melanogaster", "Danio rerio", "Caenorhabditis elegans"])
    ...
    def _prefill_data(self):
        ...
        if spec: self.species.setCurrentText(spec)
    ...
    def get_metadata(self) -> Optional[Dict[str, Any]]:
        ...
        if has_subject_info and not subj_id:
             QtWidgets.QMessageBox.warning(self, "Validation Error", "Subject ID is required if Subject information is provided.")
