...
TUTORIAL_CONTENT = r"""# Synaptipy User Tutorial and Documentation
...
def run_automation():
    ...
    # Take screenshot of Explorer Tab
    window.tab_widget.setCurrentIndex(0)
    QApplication.processEvents()
    time.sleep(0.5)
    take_screenshot(window, "explorer_tab.png")

    # Take screenshot of Analyser Tab
    window.tab_widget.setCurrentIndex(1)
    QApplication.processEvents()
    time.sleep(0.5)
    take_screenshot(window, "analyser_tab.png")

    # Take screenshot of Exporter Tab
    ...
    print(f"Successfully generated tutorial at: {TUTORIAL_FILE}")
