...
- Bumped version to `0.1.5` across all canonical locations.
...
- Bumped version to `0.1.5b6` across all canonical locations.
...
- Bumped version to `0.1.5b5` across all canonical locations.
...
- Bumped version to `0.1.1b9` across all canonical locations.
...
- Bumped version to `0.1.4rc2` across all canonical locations.
- Added `scripts/bump_version.py` to automate cross-file version bumps
  in future releases.
...
- Bumped version to `0.1.4rc1` across all canonical locations.
- Added `scripts/bump_version.py` to automate cross-file version bumps
  in future releases.
...
- Bumped version to `0.1.3b5` across all canonical locations.
- Added `scripts/bump_version.py` to automate cross-file version bumps
  in future releases.
...
- Bumped version to `0.1.3b3` across all canonical locations.
- Added `scripts/bump_version.py` to automate cross-file version bumps
  in future releases.
...
- Bumped version to `0.1.3b1` across all canonical locations.
- Added `scripts/bump_version.py` to automate cross-file version bumps
  in future releases.
...
- Bumped version to `0.1.2b11` across all canonical locations.
- Added `scripts/bump_version.py` to automate cross-file version bumps
  in future releases.
...
- Bumped version to `0.1.2b3` across all canonical locations.
- Added `scripts/bump_version.py` to automate cross-file version bumps
  in future releases.
