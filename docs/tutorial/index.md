...
4. [Analysis Modules - Detailed Reference](#analysis-modules-detailed-reference)
 - [4.1 Baseline / RMP](#baseline-rmp-analysis)
 - [4.2 Spike Detection](#42-spike-detection)
 - [4.3 Event Detection - Threshold Based](#event-detection-threshold-based)
 - [4.4 Event Detection - Template Match](#event-detection-template-match-deconvolution)
 - [4.5 Event Detection - Baseline Peak](#event-detection-baseline-peak-kinetics)
