...
1. [Overview - How the Plugin System Works](#overview-how-the-plugin-system-works)
2. [Quick Start - Your First Plugin in 5 Minutes](#quick-start-your-first-plugin-in-5-minutes)
3. [The Plugin File - Anatomy of a Custom Analysis](#the-plugin-file-anatomy-of-a-custom-analysis)
...
5. [Defining Plot Overlays (`plots`)](#5-defining-plot-overlays-plots)
 - [5.1 `hlines` - Horizontal Lines](#hlines-horizontal-lines)
 - [5.2 `vlines` - Vertical Lines](#vlines-vertical-lines)
 - [5.3 `markers` - Scatter Points](#markers-scatter-points)
 - [5.4 `interactive_region` - Draggable Region](#interactive-region-draggable-region)
 - [5.5 `threshold_line` - Draggable Threshold](#threshold-line-draggable-threshold)
 - [5.6 `overlay_fit` - Curve Overlay](#overlay-fit-curve-overlay)
 - [5.7 `popup_xy` - Popup Scatter/Line Plot](#popup-xy-popup-scatter-line-plot)
 - [5.8 `brackets` - Burst/Event Brackets](#brackets-burst-event-brackets)
 - [5.9 `event_markers` - Interactive Event Points](#event-markers-interactive-event-points)
 - [5.10 `trace` - Base Trace with Overlay](#trace-base-trace-with-overlay)
6. [Where to Put Your Plugin File](#6-where-to-put-your-plugin-file)
7. [For Core Contributors - Adding a Built-in Analysis](#for-core-contributors-adding-a-built-in-analysis)
8. [Testing Your Plugin](#8-testing-your-plugin)
9. [Full Annotated Example - Signal-to-Noise Ratio](#full-annotated-example-signal-to-noise-ratio)
